...
?>  
<!--Main JavaScript-->
<script src="js/all_sites.js?random=<?php echo uniqid(); ?>" type="text/javascript"></script>

<div class="bs-callout bs-callout-success"> 
    <h4>All Sites</h4> 
    <p>You can use this page to view all activities/sites performed since the launch of this website. Hover over one of the entries to see the <b>Technician</b> responsible for the site, the <b>Expected Go Live Date</b>, the <b>Site Code</b> and the <b>FTS</b> technician/s. You can click on <b>Read More</b> to see the sites checklist or click on the technician name to see his/her profile.</p>
</div>  
...
<br>
<h1 class="display-4" style="text-align: center;">All Sites</h1> 
